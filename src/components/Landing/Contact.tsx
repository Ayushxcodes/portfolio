...
export default function Contact({ onHover, offHover }: { onHover: () => void; offHover: () => void; }) {
  return (
    <section className="px-4 md:px-12 py-28 text-center" id="contact">
      ...
      <p className="fade-up font-mono text-[0.85rem] text-[#6a6a6a] tracking-[0.05em] max-w-full md:max-w-[380px] mx-auto mb-12 leading-[1.9]">I'm always open to interesting problems,<br />collaborations, and the occasional coffee.</p>
