...
export default function Projects({ projects, onHover, offHover }: { projects: any[]; onHover: () => void; offHover: () => void; }) {
  return (
    <section className="px-12 py-28 border-b border-[#222]" id="work">
      ...
      <div className="flex flex-col">
        {projects.map((project) => (
          <a
            key={project.num}
            href="#"
            className="group grid items-center gap-10 py-10 border-b border-[#222]
              no-underline text-inherit transition-[padding-left] duration-[0.25s]
              hover:pl-4 grid-cols-[80px_1fr_auto]"
          ...
          >
            ...
            <div>
              <div className="font-serif text-[2rem] mb-[0.4rem] leading-[1.1]">{project.title}</div>
              <div className="font-mono text-[0.72rem] text-[#6a6a6a] tracking-[0.05em] leading-[1.8] max-w-[500px]">{project.desc}</div>
