...
const defaultNavigationLinks: Navbar02NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/projects/design', label: 'UI/UX Design' },
    ],
  },
  {
    label: 'Blog',
    ...
    type: 'icon',
    items: [
      { href: '/blog/tech', label: 'Tech Articles', icon: 'BookOpenIcon' },
      { href: '/blog/tutorials', label: 'Tutorials', icon: 'LifeBuoyIcon' },
      { href: '/blog/personal', label: 'Personal Thoughts', icon: 'InfoIcon' },
    ],
  },
];
